...
<script src="${ctx}/huntoms/static/js/My97DatePicker/WdatePicker.js"></script>
	...
	$(function() {
		...
		$.getJSON('http://localhost:8080/huntoms/station/displayVDH?Year_='+temp[0]+'&Month_='+temp[1]+'&Day_='+temp[2], function(
				data) {
			...
			for ( var i = 0; i < xset.length; i++) {
				yset.push(y2set[i] / y1set[i] / 1000);
			}
			showBar(xset, yset);
...
<body>
	...
	<div id="searchContainer" class="search">
		...
		</select> <label>日期</label><input id="ymdPara" class="Wdate"
