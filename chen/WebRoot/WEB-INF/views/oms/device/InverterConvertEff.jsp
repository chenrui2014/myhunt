...
//页面加载
	...
	$(function() {
		...
		$.getJSON('http://localhost:8080/huntoms/device/displayInverterConvertEff?organ_id='+organ_id+'&Years_='+temp[0]+'&Months_='+temp[1]+'&Days_='+temp[2]+'&invNum='+invNum,
				function(data) {
