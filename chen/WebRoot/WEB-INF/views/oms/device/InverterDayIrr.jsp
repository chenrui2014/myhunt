...
//页面加载
	...
	$(function() {
		...
		$.getJSON('http://localhost:8080/huntoms/device/displayInverterDayIrr?organ_id='+organ_id+'&Years_='+temp[0]+'&Months_='+temp[1]+'&Days_='+temp[2]+'&invNum='+invNum,
	...
	function createTable(inverter) {
		...
		for(var i=0;i<len;i++){
			$('#table').append(		"<tr>"+
					...
					"<td>"+val(inverter[i].avgIrradiance)+"</td>"
					+"</tr>");
		}
	}
	function val(d){
