...
function showHighCharts(xAxis_,yAxis_){
	...
	function query(orgid,para){
		//var url='http://localhost:8080/huntoms/branch/displayStaYearEusehours'
		var  url ='<%=request.getContextPath()%>/branch/displayStaYearEusehours?orgid='+orgid+'&parayear='+para;
