...
function query(orgid,para){
	var temp = para.split('-'); 
	var url = '<%=request.getContextPath()%>/branch/displayStaDaySinglemweE?orgid='+orgid+'&parayear='+temp[0]+'&paramonth='+temp[1]+'&paraday='+temp[2];
...
<div id="searchContainer" class="search">
            ...
            <select id ="orgId">
             ...
             <label>时间</label><input id="para" class="Wdate" style="margin-top:8px;" type="text" size="12" onfocus="WdatePicker({skin:'default',dateFmt:'yyyy-M-d'})"/>
