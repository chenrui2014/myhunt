...
function showHighCharts(orgName_,xAxis_,ylAxis_,yrAxis_){
	...
	function createTable(branch) {
		...
		for(var i=0;i<len;i++){
			$('#table').append(		"<tr>"+
					"<td>"+branch[i].year+"</td>"+"<td>"+branch[i].theorye+"</td>"+"<td>"+branch[i].e+"</td>"+"<td>"+branch[i].effict+"%</td>"+"<td>"+branch[i].singlemwe+"</td>"+"<td>"+branch[i].eusehours+"</td>"
					+"</tr>");
		}
	}

	function query(orgid){
		var url ='<%=request.getContextPath()%>/branch/displayBranchYearEffic?orgid='+orgid;
