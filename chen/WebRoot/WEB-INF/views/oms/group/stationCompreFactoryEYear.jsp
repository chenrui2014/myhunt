...
<head>
		...
		function getSearchCondition() {
			  $.getJSON('http://localhost:8080/huntoms/group/getStationYearConditionData',function(data) { 
				  var yearList = [];
				   yearList = eval(data);
		...
		function getData(year) {
			...
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getStationCompreFactoryEYearData/'+year,function(data) {  
