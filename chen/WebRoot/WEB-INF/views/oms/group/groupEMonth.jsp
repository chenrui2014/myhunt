...
<head>
		...
		function getSearchCondition() {
			  $.getJSON('http://localhost:8080/huntoms/group/getGroupMonthConditionData',function(data) { 
				  var yearList = [];
				   yearList = eval(data);
		...
		function getData(year,month) {
			...
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getGroupEMonthData/'+year+'/'+month,function(data) {  
