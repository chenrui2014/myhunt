...
<head>
		...
		function getData() {
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getGroupPlanEOverYearData',function(data) {  
        ...
        function show(title, xAxisCategories, dataList) {
                ...
                plotOptions: {
                    series: {
                        ...
                        point: {
                            events: {
                                click: function(e) {
                                    location.href = 'http://localhost:8080/huntoms/group/groupPlanEYear/'+e.point.category;
                                }
                            }
                        }
                    }
            ...
            $(dataList).each(function(i, item) {
        		...
        		if (itemData.dataName == '发电量') {
        			nameCell.innerHTML = itemData.dataName + '(万度)';
        		} else if (itemData.dataName == '计划发电量') {
        			nameCell.innerHTML = itemData.dataName + '(万度)';
        		} else {
