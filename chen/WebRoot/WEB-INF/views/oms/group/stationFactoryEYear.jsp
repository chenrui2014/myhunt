...
<head>
		...
		function getData(year) {
			...
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getStationFactoryEYearData/'+year,function(data) {  
        ...
        function show(title, year, xAxisCategories, dataList) {
            ...
            $(dataList).each(function(i, item) {
        		...
        		if (itemData.dataName == '厂用电量' || itemData.dataName == '发电量') {
