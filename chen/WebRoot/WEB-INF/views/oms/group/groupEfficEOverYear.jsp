...
<head>
		...
		function getData() {
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getGroupEfficEOverYearData',function(data) {  
                ...
                plotOptions: {
                    series: {
                        ...
                        point: {
                            events: {
                                click: function(e) {
                                    location.href = 'http://localhost:8080/huntoms/group/groupEfficEYear/'+e.point.category;
                                }
                            }
                        }
                    }
