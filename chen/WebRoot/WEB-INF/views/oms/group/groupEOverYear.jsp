...
<head>
		...
		function getData() {
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getGroupEOverYearData',function(data) {  
                ...
                plotOptions: {
                    series: {
                        ...
                        point: {
                            events: {
                                click: function(e) {
                                    location.href = 'http://localhost:8080/huntoms/group/groupEYear/'+e.point.category;
                                }
                            }
                        }
                    }
