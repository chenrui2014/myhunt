...
<head>
		...
		function getData(year,month) {
			...
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getStationCompreFactoryEMonthData/'+year+'/'+month,function(data) {  
        ...
        function show(title, year, xAxisCategories, dataList) {
            ...
            $(dataList).each(function(i, item) {
        		...
        		if (itemData.dataName == '综合厂用电量' || itemData.dataName == '发电量') {
	...
	<body>
        ...
        <div id="chartContainer"  style="width: 98%; height:360px; margin:auto;margin_bottom:20px]"></div>
