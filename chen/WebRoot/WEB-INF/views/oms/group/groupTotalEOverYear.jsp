...
<head>
		...
		function getData() {
			// 获取
            $.getJSON('http://localhost:8080/huntoms/group/getGroupTotalEOverYearData',function(data) {  
        ...
        function show(title, xAxisCategories, dataList) {
                ...
                plotOptions: {
                    series: {
                        ...
                        point: {
                            events: {
                                click: function(e) {
                                    location.href = 'http://localhost:8080/huntoms/group/groupTotalEYear/'+e.point.category;
                                }
                            }
                        }
                    }
            ...
            $(dataList).each(function(i, item) {
        		...
        		if (itemData.dataName == '厂用电量') {
        			nameCell.innerHTML = itemData.dataName + '(万度)';
        		} else if (itemData.dataName == '综合厂用电量') {
        			nameCell.innerHTML = itemData.dataName + '(万度)';
        		} else {
        		...
        		$.each(itemData.dataList, function(j, dataItem) {
            		...
            		if (itemData.dataName =='厂用电率' || itemData.dataName =='综合厂用电率') {
